// https://github.com/cs0x7f/cstimer/blob/3204f8d32c269dac90fdf372b22f19687bbd1cc5/src/js/lib/min2phase.js
// From csTimer (copyright Chen Shuang, GPLv3) + some changes.
// The reason we use the version of min2phase.js embedded in csTimer is its axis filters.
...
var min2phase = (function() {
	...
	Search.prototype.solution = function(facelets, maxDepth, probeMax, probeMin, verbose, firstAxisFilter, lastAxisFilter) {
		// `verbose` also controls whether a solution or a generator is returned
		// `verbose & INVERSE_SOLUTION` nonzero => generator returned instead of solution
		initPrunTables();
